...
cat(
  badge_custom("R", "CRAN", "green", "https://cran.r-project.org/web/packages/TwoWayFEWeights/index.html"),
  badge_custom("Stata", "SSC", "blue", "https://ideas.repec.org/c/boc/bocode/s458611.html")
)
```
...
```
`r badger::badge_cran_release("TwoWayFEWeights", "green")`
`r badger::badge_cran_download("TwoWayFEWeights", "last-week", "green")`
`r badger::badge_cran_download("TwoWayFEWeights", "grand-total", "green")`
